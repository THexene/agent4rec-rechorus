...
# activity_dict
    ...
    def init_memory(self):
        ...
        embeddings_model = OpenAIEmbeddings(request_timeout = 20, openai_api_base=OPENAI_API_BASE, openai_api_key=OPENAI_API_KEY)
        embedding_size = 1536
        index = faiss.IndexFlatL2(embedding_size)
        vectorstore = FAISS(embeddings_model.embed_query, index, InMemoryDocstore({}), {}, relevance_score_fn=score_normalizer)

        LLM = ChatOpenAI(max_tokens=1000, temperature=0.3, request_timeout = 30, openai_api_base=OPENAI_API_BASE, openai_api_key=OPENAI_API_KEY)
